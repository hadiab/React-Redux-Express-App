...
store.dispatch((0, _booksActions.createBook)([{
  id: 1,
  title: 'Harry Potter',
    ...
    case 'UPDATE_BOOK':
      {
        ...
        var newBookToUpdate = _extends({}, bookToUpdate[indexToUpdate], {
          title: action.payload.title
        });

        return { books: [].concat(_toConsumableArray(bookToUpdate.slice(0, indexToUpdate)), [newBookToUpdate], _toConsumableArray(bookToUpdate.slice(indexToUpdate + 1))) };
      }
  }
  return state;
};
